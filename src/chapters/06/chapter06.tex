...
\begin{figure}[H]
    \centering
    \subimport{assets/figures/}{automaton-relop.tex}
...
\begin{figure}[H]
    \centering
    \subimport{assets/figures/}{nfa-for-grammar-regex.tex}
    \caption{}
...
\begin{labeling}{a | b}
    ...
    \item[\texttt{"+"}] il literal \texttt{"+"} (è necessario usare questo metodo di escape per poter far riferimento ad un carattere qualunque e non al metacarattere)
