...
\begin{labeling}{sam4retas}
    ...
    \item[FrostWalk] Federico Frigerio: revisore, ha realizzato la nuova CI e effettuato piccole correzioni.
    \item[silvanusbordignon] Silvanus Bordignon: revisore, ha sostituito parte delle immagini dei grafi presenti, realizzandole in Latex, migliorandone la qualità.
    \item[Congiuntivo] Simone De Carli: revisore, ha corretto e migliorato il testo di varie parti della dispensa.
\end{labeling}  
