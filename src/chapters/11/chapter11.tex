...
\begin{figure}[H]
    \centering
    \includegraphics[width=.3\textwidth]{if-then-abstract.png}  % TODO: trasformare in figure
    \caption{}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.4\textwidth]{if-else-trans.png} % TODO: trasformare in figure
    \caption{}
\end{figure}
