...
\begin{figure}[H]
    \centering
    \subimport{assets/figures/}{if-then-abstract.tex}
    \caption{}
\end{figure}
...
\begin{itemize}
    ...
    \item \(\triangleright\) è un operatore che denota la concatenazione di due (o più) segmenti di codice intermedio;
...
\begin{figure}[H]
    \centering
    \subimport{assets/figures/}{if-else-trans.tex}
    \caption{}
\end{figure}
