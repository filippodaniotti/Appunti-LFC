...
Ora, $C$ ci permette di utilizzare le due produzioni $C \to aCA$ e $C \to bCB$ (il simbolo $|$ ci dice che da $C$ posso produrre $sCA$ \emph{or} $bCB$).
...
%TODO: immagine albero 1
%TODO: immagine albero 2
