...
\begin{itemize}
    ...
    \item a questo punto estraiamo dalla cima dello stak, prendiamo il nodo estratto \(e\) e cerchiamo tutti i nodi che da \(e\) si raggiugono tramite un \(\varepsilon\)-arco; inseriamo tutti questi nello stak (se non sono già presenti) e ne segnaliamo l'inserimento settando il loro flag su \texttt{alreadyOn}.
\end{itemize}
...
\noindent Evidenziamo che le strutture usate sono:
\begin{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.4\textwidth,keepaspectratio]{b_dispari}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.4\textwidth,keepaspectratio]{a_pari}
...
\begin{figure}[H]
    \begin{minipage}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth,keepaspectratio]{nfa-b_odd-or-a_even}
    ...
    \begin{minipage}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth,keepaspectratio]{dfa-b_odd-or-a_even}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.4\textwidth,keepaspectratio]{dfa-b_odd-and-a_even}
...
\begin{figure}[H]
    \begin{minipage}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth,keepaspectratio]{pl-es4-sbs_1}
    ...
    \begin{minipage}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth,keepaspectratio]{pl-es4-sbs_2}
    ...
    \begin{minipage}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth,keepaspectratio]{pl-es4-sbs_3}
    ...
    \begin{minipage}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth,keepaspectratio]{pl-es4-sbs_4}
