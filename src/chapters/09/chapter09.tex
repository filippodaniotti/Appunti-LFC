...
Il primo passo è installare lo stato 0 dell'automa (Figura \ref{fig:ex_automa_simbolico-kernel_s0}):

% Using Figure instead of Image
\begin{figure}[H]
    \centering
    \subimport{assets/figures/}{ex_automa_simbolico-kernel_s0.tex}
    \caption{Stato 0: sulla sinistra automa simbolico, sulla destra automa LR(1)}
    \label{fig:ex_automa_simbolico-kernel_s0}
\end{figure}
...
\\
Kernel dello stato 1 (Figura \ref{fig:ex_automa_simbolico-kernel_s1}):

% Using Figure instead of Image
\begin{figure}[H]
    \centering
    \subimport{assets/figures/}{ex_automa_simbolico-kernel_s1.tex}
    \caption{Kernel stato 1: sulla sinistra automa simbolico, sulla destra automa LR(1)}
    \label{fig:ex_automa_simbolico-kernel_s1}
\end{figure}
...
\\
Kernel dello stato 2 (Figura \ref{fig:ex_automa_simbolico-kernel_s2})

% Using Figure instead of Image
\begin{figure}[H]
    \centering
    \subimport{assets/figures/}{ex_automa_simbolico-kernel_s2.tex}
    \caption{Kernel stato 2: sulla sinistra automa simbolico, sulla destra automa LR(1)}
    \label{fig:ex_automa_simbolico-kernel_s2}
\end{figure}
...
\\
Kernel dello stato 3 (Figura \ref{fig:ex_automa_simbolico-kernel_s3}):

% Using Figure instead of Image
\begin{figure}[H]
    \centering
    \subimport{assets/figures/}{ex_automa_simbolico-kernel_s3.tex}
    \caption{Kernel stato 3: sulla sinistra automa simbolico, sulla destra automa LR(1)}
    \label{fig:ex_automa_simbolico-kernel_s3}
\end{figure}
...
\\
Kernel dello stato 4 (Figura \ref{fig:ex_automa_simbolico-kernel_s4}):

% Using Figure instead of Image
\begin{figure}[H]
    \centering
    \subimport{assets/figures/}{ex_automa_simbolico-kernel_s4.tex}
    \caption{Kernel stato 4: sulla sinistra automa simbolico, sulla destra automa LR(1)}
    \label{fig:ex_automa_simbolico-kernel_s4}
\end{figure}
...
\\
Kernel dello stato 5 (Figura \ref{fig:ex_automa_simbolico-kernel_s5}):

% Using Figure instead of Image
\begin{figure}[H]
    \centering
    \subimport{assets/figures/}{ex_automa_simbolico-kernel_s5.tex}
    \caption{Kernel stato 5: sulla sinistra automa simbolico, sulla destra automa LR(1)}
    \label{fig:ex_automa_simbolico-kernel_s5}
\end{figure}

% Note that useless (?) text has been removed from the image
% \begin{figure}
%     \centering
...
\\
Kernel dello stato 6 (Figura \ref{fig:ex_automa_simbolico-kernel_s6}):

% Using Figure instead of Image
\begin{figure}[H]
    \centering
    \subimport{assets/figures/}{ex_automa_simbolico-kernel_s6.tex}
    \caption{Kernel stato 6: sulla sinistra automa simbolico, sulla destra automa LR(1)}
    \label{fig:ex_automa_simbolico-kernel_s6}
\end{figure}
...
\\
Kernel dello stato 7 (Figura \ref{fig:ex_automa_simbolico-kernel_s7}):
% Using Figure instead of Image
\begin{figure}[H]
    \centering
    \subimport{assets/figures/}{ex_automa_simbolico-kernel_s7.tex}
    \caption{Kernel stato 7: sulla sinistra automa simbolico, sulla destra automa LR(1)}
    \label{fig:ex_automa_simbolico-kernel_s7}
\end{figure}
...
\\
Kernel dello stato 8 (Figura \ref{fig:ex_automa_simbolico-kernel_s8}):

% Using Figure instead of Image
\begin{figure}[H]
    \centering
    \subimport{assets/figures/}{ex_automa_simbolico-kernel_s8.tex}
    \caption{Kernel stato 8: sulla sinistra automa simbolico, sulla destra automa LR(1)}
    \label{fig:ex_automa_simbolico-kernel_s8}
\end{figure}
...
\\
Kernel dello stato 9 (Figura \ref{fig:ex_automa_simbolico-kernel_s9}):

% Using Figure instead of Image
\begin{figure}[H]
    \centering
    \subimport{assets/figures/}{ex_automa_simbolico-kernel_s9.tex}
    \caption{Kernel stato 9: sulla sinistra automa simbolico, sulla destra automa LR(1)}
    \label{fig:ex_automa_simbolico-kernel_s9}
\end{figure}
