...
Un passaggio intermedio obbligatorio è l'automa LRm(1) \(\mathcal{AM}\), costruito a partire dall'automa LR(1) tramite raffinazione \(\mathcal{A}\) (la lettera m sta per \emph{merged}).

Gli \textbf{Stati} del nuovo automa caratteristico sono ottenuti unendo all'interno di un singolo stato di \(\mathcal{AM}\) tutti gli item negli stati \(<P_1, ..., P_n>\) di \(\mathcal{A}\) che hanno le stesse LR(0)-proiezioni (i.e. con gli stessi item LR(0)).
