...
\begin{document}
    ...
    \begin{tikzpicture}[]
        % Left side
        \node [] (0) {$S \rightarrow L = \cdot R,\{x_7\}$};
        \node [above, draw=none, font=\normalfont] at (0.north) {6:}; %label
        \node [below = 0mm of 0, fill=lightgray!50!white] (1) { 
            \begin{tabular}{@{}l}
                $ R \rightarrow \cdot L, \{x_7\}$ \\
                $ L \rightarrow \cdot \ast R, \{x_7\}$ \\
                $ L \rightarrow \cdot id, \{x_7\}$ \\
            \end{tabular}
        };
        
        % Right side
        \node [right = 5cm of 0] (2) {$S \rightarrow L = \cdot R, \{\$\}$};
        \node [above, draw=none, font=\normalfont] at (2.north) {6:}; %label
