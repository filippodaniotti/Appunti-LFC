...
\begin{proof}
  ...
  \begin{equation*}
    \exists \mathcal{G}_1 = (V_1, T_1, S_1, \mathcal{P}_1), \exists \mathcal{G}_2 = (V_2, T_2, S_2, \mathcal{P}_2) : \mathcal{L}_1 = \mathcal{L}(\mathcal{G}_1) \textrm{ e } \mathcal{L}_2 = \mathcal{L}(\mathcal{G}_2)
  \end{equation*}
...
\begin{proof}
  ...
  \noindent Questo linguaggio non è libero, e provarlo è molto semplice (si veda l'esercizio \ref{ex-freeNotFree_1}).
...
% TODO continua a correggere da qui
...
\begin{proof}
  ...
  Ulteriori considerazioni:
   \begin{itemize}
     ...
     \item la grammatica \(\mathcal{G}\) che genera il linguaggio che stiamo considerando è pulita, per cui nelle derivazioni di forma \(A \implies^* \alpha A \beta\), almeno uno dei due simboli \(\alpha, \beta\) deve fornire uno ulteriore; questo ci permette di affermare che \(|vx| > 0\).
   \end{itemize}
...
\subsection{Applicazioni}
	...
	In generale, da un'implicazione logica del tipo \(A \implies B\), è possibile ottenere la negazione \(\neg B \implies \neg A\). Nel nostro caso, da \(\mathcal{L}\) libero \(\implies\) Tesi del \emph{Pumping Lemma}, abbiamo \(Not\) tesi del \emph{Pumping Lemma} \(\implies\) \(\mathcal{L}\) \(Not\) libero.
