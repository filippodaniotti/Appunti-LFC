...
Il processo a questo risulta essere analogo a quello fatto precedentemente per il primo \(digit\) quindi ci riserviamo la libertà di non spiegare così nel dettaglio i prossimi passaggi 
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        ...
        \caption{Creazone del nodo foglia per l'identificatore che referenzia la variabile \(a\)}
    \end{figure}
