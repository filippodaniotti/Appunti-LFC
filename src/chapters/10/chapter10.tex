...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \subimport{assets/figures/}{first-ex_SDD-resolution-step-1.tex}
    ...
    \begin{figure}[H]
        \centering
        \subimport{assets/figures/}{first-ex_SDD-resolution-step-2.tex}
    ...
    \begin{figure}[H]
        \centering
        \subimport{assets/figures/}{first-ex_SDD-resolution-step-3.tex}
    ...
    \begin{figure}[H]
        \centering
        \subimport{assets/figures/}{first-ex_SDD-resolution-step-4.tex}
    ...
    \begin{figure}[H]
        \centering
        \subimport{assets/figures/}{first-ex_SDD-resolution-step-5.tex}
...
\begin{figure}[H]
    \centering
    \subimport{assets/figures/}{first-ex_sdd-dependency-graph.tex}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.5\textwidth}
        \centering
        \subimport{assets/figures/}{ast-first-example-part-1.tex}
    \end{subfigure}%
    \begin{subfigure}{.5\textwidth}
        \centering
        \subimport{assets/figures/}{ast-first-example-part-2.tex}
    \end{subfigure}%
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \subimport{assets/figures/}{ex-ast-creation-1.tex}
    ...
    \begin{figure}[H]
        \centering
        \subimport{assets/figures/}{ex-ast-creation-2.tex}
    ...
    \begin{figure}[H]
        \centering
        \subimport{assets/figures/}{ex-ast-creation-3.tex}
    ...
    \begin{figure}[H]
        \centering
        \subimport{assets/figures/}{ex-ast-creation-4.tex}
    ...
    \begin{figure}[H]
        \centering
        \subimport{assets/figures/}{ex-ast-creation-5.tex}
    ...
    \begin{figure}[H]
        \centering
        \subimport{assets/figures/}{ex-ast-creation-6.tex}
...
\begin{figure}[H]
	\centering
    \subimport{assets/figures/}{parse-tree-ae.tex}
...
\begin{figure}[H]
	\centering
    \subimport{assets/figures/}{dependency-graph-ae.tex}
...
\begin{figure}[H]
	\centering
    \subimport{assets/figures/}{dependency-graph-ae-evaluation-order.tex}
...
\begin{figure}[H]
	\centering
    \subimport{assets/figures/}{abstract-syntax-tree-ae.tex}
