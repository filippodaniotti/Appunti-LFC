...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item siccome \(\varepsilon \in first(B)\), aggiungiamo anche i \emph{first} di \(d\), che è prorio \(\{d\}\);
...
\begin{figure}[H]
    ...
    \caption{Ambiguità della fattorizzazione a sinistra}
    \label{Ambiguità della fattorizzazione a sinistra}
\end{figure}
