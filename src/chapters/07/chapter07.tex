...
\begin{gather*}
    E \Rightarrow idE' \Rightarrow id + EE' \Rightarrow id + E * EE' \Rightarrow id + E * E \Rightarrow id + E * idE' \Rightarrow id + E * id \Rightarrow id + idE' * id \Rightarrow id + id * id \\
    E \Rightarrow idE' \Rightarrow id + EE' \Rightarrow id + E \Rightarrow id + idE' \Rightarrow id + id * EE' \Rightarrow id + id * E \Rightarrow id + id * idE' \Rightarrow id + id * id
\end{gather*}
