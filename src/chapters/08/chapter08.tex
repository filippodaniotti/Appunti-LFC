...
\begin{itemize}
    ...
    \item elimineremo il body stesso da \(symSt\) e, al suo posto, inseriremo il driver della riduzione, in questo caso \(A\).
\end{itemize} 
...
I nostri conflitti sono localizzati solo in quattro situazioni, ovvero quando ci troviamo in uno tra gli stati 5 o 6 e, contemporaneamente, troviamo in lettura un simbolo tra \(+\) o \(\ast\).
