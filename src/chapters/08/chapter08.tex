...
\begin{figure}
    \centering
    \includegraphics[width=.4\textwidth]{lr0-automata_conflict.png}
...
\end{definition}
Un altro modo per descrivere questa procedura è quello di descriverne l'algoritmo, questa seconda possibilità è mostrata in Alg.\ref{alg:closure-lr1}
\begin{figure}[H]
    \centering
...
Proviamo ora a chiarire tale procedura tramite la sua scrittura in forma algoritmica, si veda \ref{alg:construct-lr1-automata}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.4\textwidth]{lr1-automata_no-conflict.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{lr1_automata-complete.png}
